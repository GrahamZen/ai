    ...
    private:
        ...
        void TF_IDF_init() {
            if (sentenceCnt == 0 || wordCnt == 0)
                throw invalid_argument("main.cpp::line 88:Data hasn't been initialized!");
...
int main() {
    //task1::output_TF_IDF();
//	auto k1 = KNN_CLASSIFICATION::train(15, 4);
//	KNN_CLASSIFICATION::test(k1);
	auto k2 = KNN_REGRESSION::train1(15, 4);
	KNN_REGRESSION::test(k2);
}